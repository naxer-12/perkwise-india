...
export const CREDIT_CARDS_DATA: CreditCard[] = [
  {
    ...
    applicationLinkText: 'Apply on ICICI Bank / Amazon Official Portal',
    sourceRef: SOURCES.ICICI_AMAZON_PAY_PORTAL,
    reviews: [
      {
        id: 'rev-apay-1',
        author: 'Rohan Nair',
  ...
  },
  {
    ...
    applicationLinkText: 'Apply via HDFC Bank Cards Official Portal',
    sourceRef: SOURCES.HDFC_MILLENNIA_PORTAL,
    reviews: [],
    cardType: 'credit',
    missionScore: 93,
  ...
  },
  {
    ...
    forexMarkup: 0,
    whyThisCardWins: 'For students, housewives, freelancers without ITR, or individuals with a damaged CIBIL score (<700), standard banks reject applications outright. IDFC WOW requires NO income proof and NO credit history — you simply open an FD of ₹2,00,0 to ₹1 Lakh and get an instant 100% credit limit with ZERO Forex markup and zero annual fee.',
    ...
    applicationLinkText: 'Apply via IDFC FIRST Bank WOW Official Portal',
  ...
  },
  {
    ...
    applicationLinkText: 'Apply via SBI Card Official SPRINT Portal',
    sourceRef: SOURCES.SBI_CASHBACK_PORTAL,
    reviews: [
      {
        id: 'rev-sbicb-1',
  ...
  },
  {
    ...
    applicationLinkText: 'Apply on HDFC Bank Swiggy Official Portal',
    sourceRef: SOURCES.HDFC_SWIGGY_PORTAL,
    reviews: [],
    cardType: 'credit',
    missionScore: 94,
  ...
  },
  {
    ...
    applicationLinkText: 'Apply on HSBC India Live+ Official Portal',
  ...
  },
  {
    ...
    applicationLinkText: 'Apply on Axis Bank Airtel Official Desk',
    sourceRef: SOURCES.AXIS_AIRTEL_PORTAL,
    reviews: [
      {
        id: 'rev-airtel-1',
  ...
  },
  {
    ...
    applicationLinkText: 'Apply via HDFC Bank Tata Neu Official Portal',
    sourceRef: SOURCES.HDFC_TATA_NEU_PORTAL,
    reviews: [],
    cardType: 'credit',
    missionScore: 96,
  ...
  },
  {
    ...
    applicationLinkText: 'Apply on Axis Bank Atlas Official Portal',
    sourceRef: SOURCES.AXIS_ATLAS_PORTAL,
    reviews: [
      {
        id: 'rev-atlas-1',
  ...
  },
  {
    ...
    applicationLinkText: 'Apply on SBI Card BPCL Octane Official Portal',
    sourceRef: SOURCES.SBI_BPCL_OCTANE_PORTAL,
    reviews: [],
    cardType: 'credit',
    missionScore: 93,
  ...
  },
  {
    ...
    applicationLinkText: 'Apply on Tata Neu RuPay Official Portal',
    sourceRef: SOURCES.TATA_NEU_RUPAY_PORTAL,
    reviews: [],
    cardType: 'credit',
    missionScore: 96,
  ...
  },
  {
    ...
    applicationLinkText: 'Apply on Kiwi Official App & Portal',
    sourceRef: SOURCES.AXIS_KIWI_PORTAL,
    reviews: [],
    cardType: 'credit',
    missionScore: 92,
  ...
  },
  {
    ...
    applicationLinkText: 'Apply on HDFC Bank Infinia Official Portal',
    sourceRef: SOURCES.HDFC_INFINIA_PORTAL,
    reviews: [],
    cardType: 'credit',
    missionScore: 99,
  ...
  },
  {
    ...
    applicationLinkText: 'Apply on Axis Bank Olympus Official Portal',
    sourceRef: SOURCES.AXIS_OLYMPUS_PORTAL,
    reviews: [],
    cardType: 'credit',
    missionScore: 92,
  ...
  },
  {
    ...
    applicationLinkText: 'Apply on HDFC Bank Millennia Debit Official Portal',
    sourceRef: SOURCES.HDFC_MILLENNIA_DEBIT_PORTAL,
    reviews: [
      {
        id: 'rev-mdebit-1',
        author: 'Arjun Mehta',
