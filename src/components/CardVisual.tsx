...
const CARD_IMAGE_FILES: Record<string, string> = {
  'phonepe-sbi-select-black': 'phonepe-sbi-select-black.svg',
  'sbi-cashback': 'sbi-cashback.png',
  'amazon-pay-icici': 'amazon-pay-icici.svg',
  'hdfc-millennia': 'hdfc-millennia.svg',
  'hdfc-millennia-debit': 'hdfc-millennia-debit.svg',
  'airtel-axis': 'airtel-axis.svg',
  'tata-neu-infinity-rupay': 'tata-neu-infinity-rupay.svg',
  'tata-neu-infinity-hdfc': 'tata-neu-infinity-hdfc.svg',
  'hdfc-infinia-metal': 'hdfc-infinia-metal.svg',
  'axis-atlas': 'axis-atlas.svg',
  'idfc-wealth-debit': 'idfc-wealth-debit.svg',
  'scapia-federal': 'scapia-federal.svg',
  'hsbc-live-plus': 'hsbc-live-plus.svg',
  'au-ixigo': 'au-ixigo.svg',
