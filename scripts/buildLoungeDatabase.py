...
data = {
    ...
    "lounges": [
        # New Delhi (DEL)
        {
            ...
            "accessType": "Domestic",
            "timings": "24 Hours",
            "amenities": ["Gourmet Hot Buffet", "High-Speed Wi-Fi", "Dedicated Workstations", "Flight Information Display", "Premium Beverages"],
            "networksAccepted": ["Visa", "Mastercard", "RuPay", "Diners Club", "Priority Pass", "DreamFolks"]
        },
        {
            "id": "del-encalm-t2",
            "type": "airport",
            ...
            "accessType": "Domestic",
            "timings": "24 Hours",
            "amenities": ["Hot Buffet", "Bar Counter", "Wi-Fi", "Comfortable Loungers", "Newspapers & Magazines"],
            "networksAccepted": ["Visa", "Mastercard", "RuPay", "Diners Club", "Priority Pass", "DreamFolks"]
        },
        {
            ...
            "accessType": "Domestic",
            "timings": "24 Hours",
            "amenities": ["Live Chef Counter", "Shower Facilities", "Gourmet Dining", "Wi-Fi", "Recliners", "Bar Service"],
            "networksAccepted": ["Visa", "Mastercard", "RuPay", "Diners Club", "Priority Pass", "DreamFolks"]
        },
        {
            ...
            "timings": "24 Hours",
            "amenities": ["Full Service Bar", "Luxury Showers", "Sleeping Pods", "Global Cuisine Buffet", "Business Center"],
            "networksAccepted": ["Priority Pass", "DreamFolks", "LoungeKey", "Diners Club", "Select Super-Premium Cards"]
        },
        # Mumbai (BOM)
        {
            "id": "bom-adani-t2-dom",
            ...
            "accessType": "Domestic",
            "timings": "24 Hours",
            "amenities": ["Gourmet Dining Spread", "Live Cooking Station", "Premium Bar", "High-Speed Wi-Fi", "Quiet Rest Zone"],
            "networksAccepted": ["Visa", "Mastercard", "RuPay", "Diners Club", "Priority Pass", "DreamFolks"]
        },
        {
            ...
            "accessType": "Domestic",
            "timings": "24 Hours",
            "amenities": ["Hot Meals & Snacks", "Coffee & Tea Bar", "Wi-Fi", "Charging Points", "Flight Displays"],
            "networksAccepted": ["Visa", "Mastercard", "RuPay", "DreamFolks"]
        },
        {
            "id": "bom-oasis-t1b",
            "type": "airport",
            ...
            "accessType": "Domestic",
            "timings": "04:00 - 23:30",
            "amenities": ["Buffet Dining", "Beverage Station", "High Speed Internet", "Comfortable Seating"],
            "networksAccepted": ["Visa", "Mastercard", "RuPay", "Priority Pass"]
        },
        {
            ...
            "accessType": "International",
            "timings": "24 Hours",
            "amenities": ["Luxury Buffet & À La Carte", "Fine Spirits Bar", "Private Cabanas", "Spa & Showers", "Wi-Fi"],
            "networksAccepted": ["Priority Pass", "DreamFolks", "Select Infinite & Super-Premium Cards"]
        },
        # Bengaluru (BLR)
        {
            "id": "blr-080-t1-dom",
            ...
            "accessType": "Domestic",
            "timings": "24 Hours",
            "amenities": ["Artisan Coffee Bar", "Microbrewery Beer Tap", "South Indian Gourmet Spread", "Shower Suites", "Library Lounge"],
            "networksAccepted": ["Visa", "Mastercard", "RuPay", "Diners Club", "Priority Pass", "DreamFolks"]
        },
        {
            "id": "blr-080-t2-dom",
            ...
            "accessType": "Domestic",
            "timings": "24 Hours",
            "amenities": ["Garden-Facing Balcony", "Curated Plant-Based & Continental Buffet", "Craft Cocktail Bar", "Nap Zones", "Ultra-Fast Wi-Fi"],
            "networksAccepted": ["Visa", "Mastercard", "RuPay", "Diners Club", "Priority Pass", "DreamFolks"]
        },
        {
            "id": "blr-080-t2-intl",
            ...
            "accessType": "International",
            "timings": "24 Hours",
            "amenities": ["Panoramic Runway Views", "International Master Buffet", "Full Cocktail Lounge", "Luxury Showers", "VIP Cabanas"],
            "networksAccepted": ["Priority Pass", "DreamFolks", "Diners Club", "Select Ultra-Premium Cards"]
        },
        # Hyderabad (HYD)
        {
            ...
            "accessType": "Domestic",
            "timings": "24 Hours",
            "amenities": ["Hyderabadi Biryani Live Counter", "Cocktail Bar", "Wi-Fi", "Spacious Seating", "Flight Updates"],
            "networksAccepted": ["Visa", "Mastercard", "RuPay", "Diners Club", "Priority Pass", "DreamFolks"]
        },
        {
            "id": "hyd-encalm-intl",
            ...
            "accessType": "International",
            "timings": "24 Hours",
            "amenities": ["Hot International Buffet", "Bar Station", "Shower Cabins", "Rest Zone", "Fast Internet"],
            "networksAccepted": ["Priority Pass", "DreamFolks", "Diners Club", "Selected Bank Cards"]
        },
        # Chennai (MAA)
        {
            ...
            "accessType": "Domestic",
            "timings": "24 Hours",
            "amenities": ["South Indian Delicacies", "Filter Coffee Station", "Wi-Fi", "Comfortable Loungers", "Beverages"],
            "networksAccepted": ["Visa", "Mastercard", "RuPay", "Priority Pass", "DreamFolks"]
        },
        {
            ...
            "accessType": "Domestic",
            "timings": "04:00 - 23:00",
            "amenities": ["Hot Buffet", "Soft Drinks & Juices", "Wi-Fi", "Charging Ports"],
            "networksAccepted": ["Visa", "Mastercard", "RuPay", "Priority Pass", "DreamFolks"]
        },
        # Kolkata (CCU)
        {
            ...
            "accessType": "Domestic",
            "timings": "24 Hours",
            "amenities": ["Bengali Sweets & Snacks", "Hot Lunch/Dinner Buffet", "Wi-Fi", "Rest Chairs", "Beverage Counter"],
            "networksAccepted": ["Visa", "Mastercard", "RuPay", "Diners Club", "Priority Pass", "DreamFolks"]
        },
        # Ahmedabad (AMD)
        {
            ...
            "accessType": "Domestic",
            "timings": "24 Hours",
            "amenities": ["Gujarati Snacks & Buffet", "Chai Bar", "Wi-Fi", "Recliners", "TV Displays"],
            "networksAccepted": ["Visa", "Mastercard", "RuPay", "Diners Club", "Priority Pass", "DreamFolks"]
        },
        {
            ...
            "accessType": "International",
            "timings": "24 Hours",
            "amenities": ["Gourmet International Buffet", "Wi-Fi", "Luxury Seating", "Flight Updates"],
            "networksAccepted": ["Priority Pass", "DreamFolks", "Select Premium Cards"]
        },
        # Goa (GOI / GOX)
        {
            ...
            "accessType": "Domestic",
            "timings": "05:00 - 23:00",
            "amenities": ["Goan Snacks & Continental Buffet", "Bar Counter", "Wi-Fi", "Rest Area"],
            "networksAccepted": ["Visa", "Mastercard", "RuPay", "Priority Pass", "DreamFolks"]
        },
        {
            "id": "goa-mopa-encalm",
            ...
            "timings": "24 Hours",
            "amenities": ["Cocktail & Mocktail Bar", "Coastal Seafood & Veg Buffet", "Scenic Runway Views", "High Speed Wi-Fi"],
            "networksAccepted": ["Visa", "Mastercard", "RuPay", "Priority Pass", "DreamFolks"]
        },
        # Pune (PNQ)
        {
            ...
            "accessType": "Domestic",
            "timings": "24 Hours",
            "amenities": ["Hot Buffet Lunch & Dinner", "Tea & Coffee Bar", "Fast Wi-Fi", "Work Desks"],
            "networksAccepted": ["Visa", "Mastercard", "RuPay", "Diners Club", "Priority Pass", "DreamFolks"]
        },
        # Jaipur (JAI)
        {
            ...
            "accessType": "Domestic",
            "timings": "05:00 - 23:00",
            "amenities": ["Rajasthani Specialties & North Indian Buffet", "Wi-Fi", "Coffee & Beverage Bar", "Comfortable Sofas"],
            "networksAccepted": ["Visa", "Mastercard", "RuPay", "Diners Club", "Priority Pass", "DreamFolks"]
        },
        # Kochi (COK)
        {
            ...
            "accessType": "Domestic",
            "timings": "24 Hours",
            "amenities": ["Kerala Traditional Cuisine & Multi-Cuisine Buffet", "Wi-Fi", "Shower Facilities", "Tea/Coffee"],
            "networksAccepted": ["Visa", "Mastercard", "RuPay", "Priority Pass", "DreamFolks"]
        },
        # Lucknow (LKO)
        {
            ...
            "accessType": "Domestic",
            "timings": "24 Hours",
            "amenities": ["Awadhi Cuisine Buffet", "Beverage Bar", "Wi-Fi", "Recliners", "Flight Status Monitors"],
            "networksAccepted": ["Visa", "Mastercard", "RuPay", "Priority Pass", "DreamFolks"]
        },
        # Chandigarh (IXC)
        {
            ...
            "accessType": "Domestic",
            "timings": "05:00 - 22:30",
            "amenities": ["Punjabi Delicacies", "Bar Beverages", "Wi-Fi", "Work Stations"],
            "networksAccepted": ["Visa", "Mastercard", "RuPay", "Priority Pass", "DreamFolks"]
        },
        # Amritsar (ATQ)
        {
            ...
            "accessType": "Domestic & International",
            "timings": "24 Hours",
            "amenities": ["Hot Buffet Meals", "Beverages", "Wi-Fi", "Comfortable Loungers"],
            "networksAccepted": ["Visa", "Mastercard", "RuPay", "Priority Pass", "DreamFolks"]
        },
        # Srinagar (SXR)
        {
            ...
            "accessType": "Domestic",
            "timings": "06:00 - 20:00",
            "amenities": ["Kashmiri Kahwa Counter", "Warm Buffet Meals", "Wi-Fi", "Heated Seating"],
            "networksAccepted": ["Visa", "Mastercard", "RuPay", "Priority Pass"]
        },
        # Bhubaneswar (BBI)
        {
            ...
            "accessType": "Domestic",
            "timings": "24 Hours",
            "amenities": ["Multi-Cuisine Buffet", "Wi-Fi", "Beverages", "Flight Monitors"],
            "networksAccepted": ["Visa", "Mastercard", "RuPay", "Priority Pass", "DreamFolks"]
        },
        # Indore (IDR)
        {
            ...
            "accessType": "Domestic",
            "timings": "05:00 - 23:00",
            "amenities": ["Indori Poha & Snacks", "Hot Buffet", "Wi-Fi", "Beverage Station"],
            "networksAccepted": ["Visa", "Mastercard", "RuPay", "Priority Pass", "DreamFolks"]
        },
        # Dehradun (DED)
        {
            ...
            "accessType": "Domestic",
            "timings": "06:00 - 21:00",
            "amenities": ["Snacks & Beverages", "Wi-Fi", "Relaxation Chairs"],
            "networksAccepted": ["Visa", "Mastercard", "RuPay", "Priority Pass", "DreamFolks"]
        },
        # Varanasi (VNS)
        {
            ...
            "accessType": "Domestic",
            "timings": "06:00 - 22:00",
            "amenities": ["Buffet Dining", "Chai Bar", "Wi-Fi", "Charging Ports"],
            "networksAccepted": ["Visa", "Mastercard", "RuPay", "Priority Pass", "DreamFolks"]
        },
        # Patna (PAT)
        {
            ...
            "accessType": "Domestic",
            "timings": "05:30 - 22:30",
            "amenities": ["Hot Meals", "Beverages", "Wi-Fi", "Comfortable Seating"],
            "networksAccepted": ["Visa", "Mastercard", "RuPay", "Priority Pass", "DreamFolks"]
        },
        # Raipur (RPR)
        {
            ...
            "accessType": "Domestic",
            "timings": "06:00 - 22:00",
            "amenities": ["Buffet Food", "Beverages", "Wi-Fi", "Recliners"],
            "networksAccepted": ["Visa", "Mastercard", "RuPay", "Priority Pass", "DreamFolks"]
        },
        # Ayodhya (AYJ)
        {
            ...
            "accessType": "Domestic",
            "timings": "07:00 - 21:00",
            "amenities": ["Pure Vegetarian Buffet", "Herbal Tea & Beverages", "Wi-Fi", "Rest Zone"],
            "networksAccepted": ["Visa", "Mastercard", "RuPay"]
        },

        # ==========================================
        # RAILWAY EXECUTIVE LOUNGES ACROSS INDIA
        # ==========================================
        {
            ...
            "timings": "24 Hours",
            "amenities": ["Complimentary Multi-Cuisine Buffet", "High-Speed Wi-Fi", "Shower & Bath Cubicles", "Massaging Recliners", "Baggage Storage Lockers", "Charging Stations", "Train Display Monitors"],
            "networksAccepted": ["Visa", "Mastercard", "RuPay", "Selected Railway Credit Cards"]
        },
        {
            ...
            "accessType": "Railway Executive Lounge",
            "timings": "24 Hours",
            "amenities": ["Air-Conditioned Dining", "Hot Buffet Breakfast/Lunch/Dinner", "Wi-Fi", "Luxury Sofa Seating", "Shower Facilities"],
            "networksAccepted": ["Visa", "Mastercard", "RuPay", "ICICI Coral/Rubyx/Sapphiro", "SBI Prime/Elite"]
        },
        {
            "id": "rail-delhi-anvt",
            "type": "railway",
            ...
            "accessType": "Railway Executive Lounge",
            "timings": "24 Hours",
            "amenities": ["Buffet Meals & Snacks", "Hot Beverages", "Clean Showers", "Free Wi-Fi", "Mobile Charging"],
            "networksAccepted": ["Visa", "Mastercard", "RuPay", "Selected Credit Cards"]
        },
        {
            ...
            "accessType": "Railway Executive Lounge",
            "timings": "24 Hours",
            "amenities": ["Gourmet Meals", "High Speed Wi-Fi", "Shower Suites", "Reclining Chairs", "Luggage Assistance"],
            "networksAccepted": ["Visa", "Mastercard", "RuPay", "ICICI/SBI Railway Cards"]
        },
        {
            ...
            "accessType": "Railway Executive Lounge",
            "timings": "24 Hours",
            "amenities": ["Pure Vegetarian Buffet", "Tea & Coffee", "Wi-Fi", "Air Conditioned Lounge", "Washrooms"],
            "networksAccepted": ["Visa", "Mastercard", "RuPay", "ICICI", "SBI"]
        },
        {
            "id": "rail-agra-cantt",
            "type": "railway",
            ...
            "accessType": "Railway Executive Lounge",
            "timings": "24 Hours",
            "amenities": ["Multi-Cuisine Buffet", "Wi-Fi", "Recliners", "Baggage Storage", "Beverages"],
            "networksAccepted": ["Visa", "Mastercard", "RuPay", "Credit Cards with Railway Benefits"]
        },
        {
            "id": "rail-jaipur-jn",
            "type": "railway",
            ...
            "accessType": "Railway Executive Lounge",
            "timings": "24 Hours",
            "amenities": ["Rajasthani Buffet", "Hot Beverages", "Clean Washrooms & Showers", "Free Wi-Fi", "Television"],
            "networksAccepted": ["Visa", "Mastercard", "RuPay", "Selected Credit Cards"]
        },
        {
            ...
            "accessType": "Railway Executive Lounge",
            "timings": "24 Hours",
            "amenities": ["Vegetarian Buffet Spread", "Beverages", "Wi-Fi", "Shower Cabins", "Rest Zone"],
            "networksAccepted": ["Visa", "Mastercard", "RuPay", "ICICI", "SBI"]
        },
        {
            "id": "rail-madurai-jn",
            ...
            "accessType": "Railway Executive Lounge",
            "timings": "24 Hours",
            "amenities": ["South Indian Buffet & Tiffin", "Wi-Fi", "Air Conditioned Resting Sofas", "Shower Facilities"],
            "networksAccepted": ["Visa", "Mastercard", "RuPay", "Selected Cards"]
        }
    ],
...
# Write to server/data/lounges.json
os.makedirs('server/data', exist_ok=True)
with open('server/data/lounges.json', 'w', encoding='utf-8') as f:
    json.dump(data, f, indent=2, ensure_ascii=False)

print(f"Successfully generated server/data/lounges.json with {len(data['lounges'])} lounges and {len(data['cards'])} cards!")
